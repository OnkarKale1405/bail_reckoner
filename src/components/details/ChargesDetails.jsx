...
const ChargesDetails = () => {
    const charges = [
        { id: 1, description: 'Forgery', date: '2023-08-12', status: 'Pending' },
        { id: 2, description: 'Fraud', date: '2023-07-30', status: 'In Progress' },
        { id: 3, description: 'Embezzlement', date: '2023-09-02', status: 'Resolved' },
    ];

    return (
        <div className='h-[45%] p-4'>
            <h3 className="text-lg font-semibold mb-4">Charges Details</h3>
